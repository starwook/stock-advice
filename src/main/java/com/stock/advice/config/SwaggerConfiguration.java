package com.stock.advice.config;
...
public class SwaggerConfiguration {
    private static final String API_NAME = "AIM API";
    private static final String API_VERSION = "1.0.0";
    private static final String API_DESCRIPTION = "AIM API 명세서";
    ...
    public Docket getDocket(String groupName, Predicate<String> predicate) {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .groupName(groupName)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.stock.advice"))
                .paths(predicate)
